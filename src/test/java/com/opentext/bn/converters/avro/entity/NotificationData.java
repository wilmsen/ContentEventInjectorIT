...
public class NotificationData extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -1352034093773117424L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"NotificationData\",\"namespace\":\"com.opentext.bn.converters.avro.entity\",\"fields\":[{\"name\":\"key\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}},{\"name\":\"value\",\"type\":{\"type\":\"string\",\"avro.java.string\":\"String\"}}]}");
   ...
   */
  public NotificationData(java.lang.String key, java.lang.String value) {
    this.key = key;
    this.value = value;
  }
   ...
   */
  public static com.opentext.bn.converters.avro.entity.NotificationData.Builder newBuilder() {
    return new com.opentext.bn.converters.avro.entity.NotificationData.Builder();
  }
   ...
   * @return A new NotificationData RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.NotificationData.Builder newBuilder(com.opentext.bn.converters.avro.entity.NotificationData.Builder other) {
    return new com.opentext.bn.converters.avro.entity.NotificationData.Builder(other);
  }
   ...
   * @return A new NotificationData RecordBuilder
   */
  public static com.opentext.bn.converters.avro.entity.NotificationData.Builder newBuilder(com.opentext.bn.converters.avro.entity.NotificationData other) {
    return new com.opentext.bn.converters.avro.entity.NotificationData.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<NotificationData>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.NotificationData.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.opentext.bn.converters.avro.entity.NotificationData other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.key)) {
        this.key = data().deepCopy(fields()[0].schema(), other.key);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.NotificationData.Builder setKey(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.NotificationData.Builder clearKey() {
      key = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.NotificationData.Builder setValue(java.lang.String value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.opentext.bn.converters.avro.entity.NotificationData.Builder clearValue() {
      value = null;
